...
If you want to add custom styles, create a directory, add your custom styles and register the
styles directory via
````python
from mplstyles import register_style_dir

register_style_dir("./dirname")
...
````
